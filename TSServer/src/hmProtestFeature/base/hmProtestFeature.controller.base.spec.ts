...
describe("HmProtestFeature", () => {
  ...
  beforeAll(async () => {
    const moduleRef = await Test.createTestingModule({
      providers: [
        {
          provide: HmProtestFeatureService,
          useValue: service,
        },
      ],
  ...
  test("POST /hmProtestFeatures", async () => {
    await request(app.getHttpServer())
      .post("/hmProtestFeatures")
      .send(CREATE_INPUT)
  ...
  test("GET /hmProtestFeatures", async () => {
    await request(app.getHttpServer())
      .get("/hmProtestFeatures")
  ...
  test("GET /hmProtestFeatures/:id non existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/hmProtestFeatures"}/${nonExistingId}`)
  ...
  test("GET /hmProtestFeatures/:id existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/hmProtestFeatures"}/${existingId}`)
      .expect(HttpStatus.OK)
      .expect({
        ...FIND_ONE_RESULT,
  ...
  test("POST /hmProtestFeatures existing resource", async () => {
