...
@ArgsType()
class UpdateHmProtestAccountUserArgs {
  @Field(() => HmProtestAccountUserWhereUniqueInput, { nullable: false })
  where!: HmProtestAccountUserWhereUniqueInput;
  @Field(() => HmProtestAccountUserUpdateInput, { nullable: false })
  data!: HmProtestAccountUserUpdateInput;
}

export { UpdateHmProtestAccountUserArgs };
