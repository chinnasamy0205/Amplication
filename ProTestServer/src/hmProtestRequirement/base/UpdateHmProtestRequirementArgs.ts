...
@ArgsType()
class UpdateHmProtestRequirementArgs {
  @Field(() => HmProtestRequirementWhereUniqueInput, { nullable: false })
  where!: HmProtestRequirementWhereUniqueInput;
  @Field(() => HmProtestRequirementUpdateInput, { nullable: false })
  data!: HmProtestRequirementUpdateInput;
}

export { UpdateHmProtestRequirementArgs };
